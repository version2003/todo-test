...
import SuggestMissingTasks from "../../../../components/add-task/suggest-task";
// import MobileNav from "../../../../../components/nav/mobile-nav";
import SideBar from "../../../../components/Side-bar";
import DeleteProject from "@/components/projects/delete-projects";
...
export default function ProjectIdPage() {
  ...
  const inCompletedTodosByProject =
    useQuery(api.todo.getInCompleteTodosByProjectId, {
      projectId,
    }) ?? [];
  const completedTodosByProject =
    useQuery(api.todo.getCompletedTodosByProjectId, {
      projectId,
    }) ?? [];
  ...
  const projectTodosTotal =
    useQuery(api.todo.getTodosTotalByProjectId, {
      projectId,
    }) || 0;
